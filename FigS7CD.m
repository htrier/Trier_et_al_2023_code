...
% Set model
currModel = {'switchToCheck','timepressure','time','reward','constant','PPI3_switchToCheckXtimepressure'};
...
regnames = {'switchToCheck','timepressure','time','reward','seedTC','constant',...
    ...
    'proximity'};
reglabels = {'Predator Discovery','Time pressure','Time','Reward','seedTC','Constant',...
...
for r = 1:length(roi)
    ...
    for a = 1:length(subjects)
        ...
        for i = 1:size(roi_TC,2)
            ...
            clear dmat contrasts REG.checkNotForage REG.time REG.constant
        end
